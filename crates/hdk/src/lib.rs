...
//! Using the HDK, hApp developers can focus on their application's logic. [Learn more about WASM in Holochain.](https://github.com/holochain/holochain-hdk/blob/main/crates/hdk/ON-WASM.md)
//!
...
//!   - This is a regular zome function, so in order for remote agents to send signals to this zome, a [capability grant](crate::capability::create_cap_grant) (e.g., with [`GrantConstraint::Unrestricted`](crate::prelude::GrantConstraint::Unrestricted)) must be created for the appropriate agent(s).
